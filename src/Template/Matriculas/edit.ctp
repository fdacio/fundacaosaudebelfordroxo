    ...
    <div class="box box-primary">
        <div class="box-body">
    		...
    		<fieldset>
        		...
        		<div class="row">
    				<div class="col-md-12">
    					<?= $this->Form->input('alunos', ['label' => 'Aluno', 'id' => 'aluno', 'type' => 'text', 'required' => false, 'value' => $matricula->aluno->nome]) ?>
    					<?= $this->Form->hidden('alunos_id', ['id' => 'alunos_id', 'value' => $matricula->alunos_id]) ?>    					
    				</div>
    			</div>
        		<div class="row">
    				<div class="col-md-12">
