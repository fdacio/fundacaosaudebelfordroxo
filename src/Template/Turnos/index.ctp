<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="box box-primary">
			<div class="box-body">
                <?= $this->Form->create($turnos, ['class' => 'form-inline', 'url' => ['action' => 'index'], 'type' => 'get']); ?>                    
                    <fieldset>
						...
						<td>
                               <div class="btn-group pull-right flex">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                        	<li><?= $this->Html->link('Ver', ['action' => 'view', $turno->id]); ?></li>	
             								<li><?= $this->Html->link('Alterar', ['action' => 'edit', $turno->id]); ?></li>
             								<li><?= $this->Form->postLink('Excluir', ['action' => 'delete', $turno->id], ['confirm' => 'Tem certeza que deseja excluir?']); ?></li>
                            			</ul>
                            	</div>
                        </td>
					</tr>
