...
class Fpdf
{
 ...
 // PDF version number
    ...
    protected function SetAligns($a)
    {
        // Set the array of column alignments
        $this->aligns = $a;
    }

    protected function SetBorderRow($boolean){
        $this->borderRow = $boolean;
    }
    /*
     * @hm corresponde a altura da linha da multicell
     */
    function Row($data, $border = 1, $hm = 5, $f = false)
    {
        ...
        for ($i = 0; $i < count($data); $i ++) {
            ...
            $y = $this->GetY();
            // Draw the border
            $this->borderRow = $border;
            if($this->borderRow){
                $this->Rect($x, $y, $w, $h);
            }
            // Print the text
            $this->MultiCell($w, $hm, $data[$i], 0, $a, $f);
